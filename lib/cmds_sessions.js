...
* TODO: fix default session
* TODO: save session at shutdown
* TODO: make session name visible somewhere
...
//console.log('inited - sessions:', storage.sessions)
...
require('sdk/system/unload').when(function() {
  var currentSessionName = storage.lastActiveSessionName || 'default'
